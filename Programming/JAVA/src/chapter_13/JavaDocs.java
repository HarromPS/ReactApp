...
// To provide the information about the classes & its methods in detail
interface Camera {
    /**
...
public class JavaDocs {
    ...
    /**
     * This is a decription of the method
     * @param k this is a integer of a counter
     * @throws Exception if k<1
     * @deprecated This method ios no longer used
     */
    public void sub(int k) throws Exception
     {
        if(k<1){
            throw new Exception();
        }
